var citySelect = {
    ...
    city: {
        "28": [["000", "张掖市"], ["001", "武威市"], ["002", "天水市"], ["003", "庆阳市"], ["004", "平凉市"], ["005", "陇南市"], ["006", "临夏州"], ["007", "兰州市"], ["008", "酒泉市"], ["009", "金昌市"], ["010", "嘉峪关市"], ["011", "甘南藏族"], ["012", "定西市"], ["013", "白银市"]],
        "1": [["014", "重庆市"]],
        ...
        "6": [["073", "兴安盟"], ["074", "锡林郭勒盟"], ["075", "乌兰察布"], ["076", "乌海市"], ["077", "通辽市"], ["078", "呼伦贝尔"], ["079", "呼和浩特"], ["080", "鄂尔多斯"], ["081", "赤峰市"], ["082", "包头市"], ["083", "巴彦淖尔市"], ["084", "阿拉善盟"]],
        "7": [["085", "长治市"], ["086", "运城市"], ["087", "阳泉市"], ["088", "忻州市"], ["089", "太原市"], ["090", "朔州市"], ["091", "吕梁市"], ["092", "临汾市"], ["093", "晋中市"], ["094", "晋城市"], ["095", "大同市"]],
        "8": [["096", "西宁市"], ["097", "海东市"], ["098", "海西蒙古族"]],
        "9": [["099", "自贡市"], ["100", "资阳市"], ["101", "宜宾市"], ["102", "雅安市"], ["103", "遂宁市"], ["104", "攀枝花市"], ["105", "内江市"], ["106", "南充市"], ["107", "绵阳市"], ["108", "眉山市"], ["109", "泸州市"], ["110", "凉山州"], ["111", "凉山彝族"], ["112", "乐山市"], ["113", "广元市"], ["114", "广安市"], ["115", "甘孜藏族"], ["116", "德阳市"], ["117", "达州市"], ["118", "成都市"], ["119", "巴中市"], ["120", "阿坝藏族"]],
        "10": [["121", "贵阳市"], ["122", "遵义市"], ["123", "铜仁市"], ["124", "黔西南布依族"], ["127", "六盘水市"], ["128", "毕节市"], ["129", "安顺市"]],
        "11": [["130", "昭通市"], ["131", "玉溪市"], ["132", "西双版纳"], ["133", "文山壮族"], ["134", "曲靖市"], ["135", "普洱市"], ["136", "临沧市"], ["137", "丽江市"], ["138", "昆明市"], ["139", "红河彝族"], ["140", "德宏傣族"], ["141", "大理白族"], ["142", "楚雄彝族"], ["143", "保山市"]],
        "12": [["144", "榆林市"], ["145", "延安市"], ["146", "咸阳市"], ["147", "西安市"], ["148", "渭南市"], ["149", "铜川市"], ["150", "商洛市"], ["151", "汉中市"], ["152", "宝鸡市"], ["153", "安康市"],],
        "13": [["154", "咸阳市"], ["155", "拉萨市"]],
        "14": [["156", "银川市"], ["157", "吴忠市"], ["158", "石嘴山市"], ["159", "固原市"]],
        "15": [["160", "乌鲁木齐"], ["161", "阿拉尔市"], ["162", "伊犁哈萨克"], ["163", "五家渠市"], ["164", "吐鲁番市"], ["165", "石河子市"], ["166", "克拉玛依市"], ["167", "喀什地区"], ["168", "和田地区"], ["169", "哈密市"], ["170", "昌吉回族"], ["171", "巴音郭楞"], ["172", "阿克苏"]],
        ...
        "18": [["189", "株洲市"], ["190", "长沙市"], ["191", "张家界市"], ["192", "岳阳市"], ["193", "永州市"], ["194", "益阳市"], ["195", "湘西土家"], ["196", "湘潭市"], ["197", "邵阳市"], ["198", "娄底市"], ["199", "怀化市"], ["200", "衡阳市"], ["201", "郴州市"], ["202", "常德市"]],
        "19": [["203", "宜昌市"], ["204", "孝感市"], ["205", "襄阳市"], ["206", "咸宁市"], ["207", "仙桃市"], ["208", "武汉市"], ["209", "天门市"], ["210", "随州市"], ["211", "十堰市"], ["212", "潜江市"], ["213", "荆州市"], ["214", "荆门市"], ["215", "黄石市"], ["216", "黄冈市"], ["217", "恩施土家族"], ["218", "鄂州市"]],
        ...
        "25": [["294", "上海市"]],
        "26": [["295", "伊春市"], ["296", "绥化市"], ["297", "双鸭山市"], ["298", "齐齐哈尔市"], ["299", "七台河市"], ["300", "牡丹江市"], ["301", "佳木斯市"], ["302", "鸡西市"], ["303", "黑河市"], ["304", "鹤岗市"], ["305", "哈尔滨市"], ["306", "大兴安岭"], ["307", "大庆市"]],
        "27": [["308", "长春市"], ["309", "延边朝鲜"], ["310", "通化市"], ["311", "松原市"], ["312", "四平市"], ["313", "辽源市"], ["314", "吉林市"], ["315", "白山市"], ["316", "白城市"]],
        "0": [["317", "北京市"]],
        "29": [["318", "天津市"]],
    ...
    dragDown: document.getElementsByClassName('dragDown')[0],
    ...
    showProvince: function() {
        ...
        this.fontStr.onclick = function() {
            if(self.key) {
                self.key = false;
                self.dragDown.style.display = 'block';
                self.ishow.style.backgroundPosition = '0 -2067px';
            }else {
                self.key = true;
                self.dragDown.style.display = 'none';
    ...
    showCity: function() {
        ...
        for(var i = 0; i < len; i++) {
            strPro += '<li>' + this.province[i] + '</li>';
        }
        this.ul_province.innerHTML = '';
        this.ul_province.innerHTML = strPro;
    ...
    citymouseEnter: function(e) {
        ...
        var cities = this.city[e.target.index];
        this.ul_city = this.cityNode.getElementsByTagName('ul')[0];
        var strCity = '';
        for(var j = 0; j < cities.length; j++) {
            strCity += '<li>' + cities[j][1] + '</li>';
        }
    ...
    cityClick: function(e) {
        ...
        this.dragDown.style.display = 'none';
